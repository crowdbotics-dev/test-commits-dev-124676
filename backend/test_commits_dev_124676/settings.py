"""
Django settings for test_commits_dev_124676 project.
...
ROOT_URLCONF = 'test_commits_dev_124676.urls'
...
WSGI_APPLICATION = 'test_commits_dev_124676.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_commits_dev_124676 API",
    "DESCRIPTION": "API documentation for test_commits_dev_124676 App",
    "VERSION": "v1",
}
